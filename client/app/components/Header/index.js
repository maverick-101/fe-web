			...
			<header className={`clearfix ${style.headerContainer} ${this.props.user.user ? style.loggedIn : ''} ${this.props.header.absolute ? ((document.body.clientWidth > 768) ? (style.absolute) : '') : ''} ${this.props.header.absoluteTwo ? style.absoluteTwo : ''}`}>
				...
				<div id="appHeader" className={style.headerWrapper}>
					...
					<ul className={`list-inline pull-right hidden-xs no-margin ${style.headerWrapper_nav}`}>
						<li><a id="Agents" href="/agents" className={["agents"].indexOf(window.location.pathname.split('/')[1]) != -1 ? style.headerWrapper_navActive : ''}>Agents</a></li>
						<li><a id="Developers" href="/developers" className={["developers"].indexOf(window.location.pathname.split('/')[1]) != -1 ? style.headerWrapper_navActive : ''}>Developers</a></li>
						<li><a id="Projects" href="/projects" className={["projects"].indexOf(window.location.pathname.split('/')[1]) != -1 ? style.headerWrapper_navActive : ''}>Projects</a></li>
						{/* <li><a id="Wanted" href="/wanted" className={`${style.headerWrapper_wantedButton}`}>Wanted</a></li> */}
						<li><a id="AddProperty" href="/add" className={`${style.headerWrapper_addButton}`}>Add Property</a></li>
					</ul> : null
				}
				{ 
						!this.props.isMobile && this.props.prebootFlag ? 
